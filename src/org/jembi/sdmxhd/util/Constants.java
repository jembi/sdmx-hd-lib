...
public class Constants {
	...
	public static final String INDICATOR_DISAGGREGATION_HIERARCHY = "HY_INDICATOR_DISAGGREGATION";
	public static final String HCL_CONFIGURATION_HIERARCHIES = "HCL_CONFIGURATION_HIERARCHIES";
