...
public class SeriesTest {
	...
	public void testToXML() throws Exception {
		...
		Series s = new Series();
		s.addAttribute("TEST1", "test1");
		s.addAttribute("TEST2", "test2");
		s.addAttribute("TEST3", "test3");
		...
		// Assert.assertEquals("<ns:Series TEST2=\"test2\" TEST3=\"test3\" TEST1=\"test1\"><ns:Obs TEST2=\"test2\" TEST3=\"test3\" TEST1=\"test1\"></ns:Obs><ns:Obs TEST2=\"test2\" TEST3=\"test3\" TEST1=\"test1\"></ns:Obs><ns:Obs TEST2=\"test2\" TEST3=\"test3\" TEST1=\"test1\"></ns:Obs></ns:Series>",
		// w.toString());
	}
