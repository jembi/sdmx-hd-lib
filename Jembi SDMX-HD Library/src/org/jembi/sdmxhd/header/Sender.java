 ...
 * 
 *         This object represents a Sender in a SDMX-HD Header
 */
public class Sender implements XMLWritable {
	...
	/**
	 * Converts this Sender to its SDMX-HD XML form and writes it to the
	 * specified xmlWriter
	 * 
	 * @param xmlWriter
